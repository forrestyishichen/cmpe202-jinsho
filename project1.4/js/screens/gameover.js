game.GameOverScreen = me.ScreenObject.extend({
    ...
    onResetEvent: function() {
        ...
        if (!me.save.topScores) me.save.add({topScores: game.data.scores});
        if (game.data.score > me.save.topScores) {
            me.save.topScores = game.data.score;
        ...
        if (game.data.newHiScore) {
            ...
            me.game.world.addChild(newRect, 11);
        }
        ...
        this.dialog = new (me.Renderable.extend({
            ...
            init: function() {
                ...
                this.steps = 'Steps: ' + game.data.score.toString();
